...
![액터 배치](../images/week_01/06/d06-01.png)

액터 배치 → Basic → 트리거 박스를 레벨에 배치해준다.

![Trigger Box](../images/week_01/06/d06-02.png)
...
![Add on Actor Begin Overlap 이벤트](../images/week_01/06/d06-03.png)
...
![Sphere Collision](../images/week_01/06/d06-03.png)
...
![액터가 나를 바라보게 만들기](../images/week_01/06/d06-04.png)
...
![액터가 계속 나를 바라보게 만들기](../images/week_01/06/d06-05.png)
...
![보간 작업](../images/week_01/06/d06-06.png)
...
![충돌 이벤트 구현](../images/week_01/06/d06-07.png)
