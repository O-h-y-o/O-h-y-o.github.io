...
![Online Learning Kit 애셋](../images/week_01/w01/w01-01.png) <br />
![Lower Sector Building Kit 애셋](../images/week_01/w01/w01-02.png)

`Online Learning Kit`과 `Lower Sector Building Kit` 을 검색하여 라이브러리에 추가를 해준다.

### 애셋 확인 및 사용

![런처에서 다운로드한 애셋 확인](../images/week_01/w01/w01-03.png)
...
![Online Learning Kit 프로젝트 실행 화면](../images/week_01/w01/w01-07.png)

프로젝트가 잘 실행 되었으면, 아까 다운로드 받은 `Lower Sector Building Kit` 을 프로젝트에 추가해야한다.

![애셋 지원 버전 확인 방법](../images/week_01/w01/w01-08.png)
...
![프로젝트에 애셋 추가](../images/week_01/w01/w01-09.png)

애셋을 추가하고 5.5 버전으로 업그레이드한 뒤 프로젝트를 실행하면, 오른쪽 하단에 `import` 를 할 것인지에 대한 창이 나온다.

![import 하기](../images/week_01/w01/w01-10.png)
...
![OnlineLearning 레벨에 LowerSector 애셋 불러오기](../images/week_01/w01/w01-11.png)
...
![메인 툴바 애셋 추가 버튼](../images/week_01/w01/w01-12.png)
...
![액터 복제](../images/week_01/w01/w01-13.png)
...
![레벨 블루포인트 열기](../images/week_01/w01/w01-14.png)

메인 툴바에서 레벨 블루포인트 열기를 통해서 액터를 생성할 수 있다.

![블루프린트 액터 생성 예제](../images/week_01/w01/w01-15.png)
...
![레벨에서 액터 확인](../images/week_01/w01/w01-16.png)
...
![콘텐츠 드로어에 블루프린트 생성](../images/week_01/w01/w01-17.png)

생성한 블루프린트를 더블클릭

![캐릭터 메시 추가](../images/week_01/w01/w01-18.png)

좌측 Component 패널에서 Mesh 를 선택해주고 우측의 Detail 패널의 Mesh에서 Skeletal Mesh Asset을 선택해주면 된다.

### 캐릭터 크기 조절 및 배치

![캐릭터 크기 조절](../images/week_01/w01/w01-19.png)
...
![레벨에 캐릭터 배치](../images/week_01/w01/w01-20.png)
...
![상황에 따른 카메라 자동 조절](../images/week_01/w01/w01-21.png)
...
![Input 애셋 생성](../images/week_01/w01/w01-22.png)
...
![Input 애셋 설정](../images/week_01/w01/w01-23.png)
...
![키 입력 상세 설정](../images/week_01/w01/w01-24.png)
...
![인풋 매핑 컨텍스트 & 액션 값 세팅](../images/week_01/w01/w01-25.png)
...
![블루프린트 설정](../images/week_01/w01/w01-26.png)
...
![IA_NBC_Move 노드 설정](../images/week_01/w01/w01-27.png)
...
![IA_NBC_Move 노드 설정](../images/week_01/w01/w01-30.png)
...
![점프 설정](../images/week_01/w01/w01-31.png)
...
![IA_NBC_Look 노드 설정](../images/week_01/w01/w01-28.png)
...
![마우스 Y축 반전](../images/week_01/w01/w01-29.png)
...
![A_BOT_IDEL](../images/week_01/w01/w01-34.png)
...
![기본 애니메이션 적용](../images/week_01/w01/w01-35.png)
...
![블랜드 스페이스(BS) 생성](../images/week_01/w01/w01-38.png)

콘텐츠 브라우저에서 별개의 Anim 폴더를 생성하고 BS_RunWalk 블랜드 스페이스 애셋을 생성한다.

![](../images/week_01/w01/w01-39.png)

설정하지 않아도 되지만 보기좋게

![](../images/week_01/w01/w01-40.png)
...
![Run Walk Animation](../images/week_01/w01/run-walk-animation.gif)
...
![스테이트 에일리어스](../images/week_01/w01/w01-43.png)

### 예제

![스테이트 머신 구조](../images/week_01/w01/w01-44.png)
...
![EventGraph에 점프 설정 추가](../images/week_01/w01/w01-45.png)
...
![AnimGraph 스테이트 머신 구성](../images/week_01/w01/w01-46.png)
...
![State Alias 설정](../images/week_01/w01/w01-47.png)
...
![Transition Rule 설정](../images/week_01/w01/w01-48.png)
...
![점프 착지 애니메이션 추가](../images/week_01/w01/all-animation.gif)
