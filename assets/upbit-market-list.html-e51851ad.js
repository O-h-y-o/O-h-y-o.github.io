import{a as l}from"./axios-4a70c6fc.js";import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{h as u,j as r,r as a,o as k,c as d,e as t,f as n}from"./app-652e2df5.js";const v=n(`<h1 id="업비트-오픈api로-거래소-페이지-만들어보기-마켓-리스트" tabindex="-1"><a class="header-anchor" href="#업비트-오픈api로-거래소-페이지-만들어보기-마켓-리스트" aria-hidden="true">#</a> 업비트 오픈API로 거래소 페이지 만들어보기 - 마켓 리스트</h1><p>이번에는 원화 마켓 리스트를 만들어 보겠습니다.</p><p>업비트 API로 원화 마켓 정보를 먼저 불러오겠습니다.</p><div class="hint-container info"><p class="hint-container-title">API Response 예시</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// MarketList.vue</span>
...
<span class="token keyword">import</span> axios <span class="token keyword">from</span> <span class="token string">&quot;axios&quot;</span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> ref<span class="token punctuation">,</span> onMounted <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&quot;vue&quot;</span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> useUpbitSocketStore <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&quot;../stores/socket-upbit&quot;</span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> objSort <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&quot;../utils/rule&quot;</span><span class="token punctuation">;</span>
