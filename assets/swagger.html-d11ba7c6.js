import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as e}from"./app-7e1a2c26.js";const t={},i=e(`<h1 id="nodejs-swagger-api-문서-만들기-typescript" tabindex="-1"><a class="header-anchor" href="#nodejs-swagger-api-문서-만들기-typescript" aria-hidden="true">#</a> Nodejs Swagger API 문서 만들기 (typescript)</h1><p>먼저 패키지 설치를 해주세요.</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">yarn</span> <span class="token function">add</span> @types/swagger-jsdoc @types/swagger-ui-express <span class="token parameter variable">-D</span>
