import{a as i}from"./axios-9cbf0d09.js";import{_ as u}from"./plugin-vue_export-helper-c27b6911.js";import{h as k,i as r,r as p,o as d,c as v,a as n,t as m,e,b,f as s}from"./app-864f7ff2.js";const g=n("h1",{id:"업비트-오픈api로-거래소-페이지-만들어보기-거래-현황",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#업비트-오픈api로-거래소-페이지-만들어보기-거래-현황","aria-hidden":"true"},"#"),b(" 업비트 오픈API로 거래소 페이지 만들어보기 - 거래 현황")],-1),y=n("p",null,"UpbitTrade.vue 파일을 새로 만들어줍니다.",-1),q=n("p",null,"지난번처럼 Trade API 를 먼저 호출해보겠습니다.",-1),f=n("p",null,"20개의 데이터를 가져오겠습니다.",-1),w={class:"hint-container info"},h=s(`<p class="hint-container-title">Codes</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// socket-upbit.ts</span>
