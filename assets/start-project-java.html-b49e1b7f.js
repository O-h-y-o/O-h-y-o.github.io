import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as e}from"./app-49b921cd.js";const i={},p=e(`<h1 id="자바로-백엔드-시작하기" tabindex="-1"><a class="header-anchor" href="#자바로-백엔드-시작하기" aria-hidden="true">#</a> 자바로 백엔드 시작하기</h1><p>자바 언어로 백엔드 API를 만들어보겠습니다.</p><p>시작에 앞서 자바 version 17, IntelliJ IDEA Community 최신 버전을 설치해주세요.</p><p>자바같은 경우에는 환경변수도 추가해주세요.</p><p><code>ex) 시스템변수 =&gt; 새로 만들기 =&gt; 변수 이름 = JAVA_HOME / 변수 값 = C:\\Program Files\\Java\\jdk-17</code></p><p>다음으로 IntelliJ 를 실행시키고 새 프로젝트를 만들어주세요.<br> 적당한 폴더 이름과 경로를 잘 지정해주고 언어는 자바, 빌드시스템은 Gradle, JDK는 17 (Oracle OpenJDK), Gradle DSL은 Groovy로 설정해주세요.</p><p><code>src/main/java/org.example</code> 경로에 들어와서 Application.java 클래스를 생성해주세요. org.example 폴더 오른쪽클릭 =&gt; new =&gt; Java Class 를 누르고 파일 이름을 적으면 됩니다. 스프링부트로 실행시킬 메인 파일을 생성하는 것입니다.</p><p><code>build.gradle</code> 파일을 찾아서 다음 문구를 추가해주세요.</p><div class="language-groovy line-numbers-mode" data-ext="groovy"><pre class="language-groovy"><code>plugins <span class="token punctuation">{</span>
